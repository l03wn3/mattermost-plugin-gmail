...
const (
	...
	commonHelpText = "\n* `/gmail connect` - Connect your Mattermost account to your Gmail account\n" +
		...
		"* `/gmail addoutputchannel` - Add a channel where the Gmail bot will send mail notifications.\n" +
		"* `/gmail removeoutputchannel` - Set channel where the Gmail bot will send mail notifications\n" +
